...
check('developer console hidden behind dev mode','dev-only hidden' in html and '?dev=1' in html+js)
...
check('part version marked', (ROOT/'VERSION').read_text().strip().startswith(('0.3.0-part','0.3.5','0.4.','0.5.','0.6.','0.7.','0.8.')))
